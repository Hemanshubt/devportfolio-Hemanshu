---
title: "DevOps Project-28: OpenAI Chatbot UI Deployment on Amazon EKS Using Jenkins and Terraform"
summary: This project demonstrates deploying an OpenAI-powered Chatbot UI application to Amazon EKS using Terraform for infrastructure provisioning and Jenkins for orchestrating the CI/CD pipeline, following DevSecOps principles.
objective: Automate the deployment of an OpenAI Chatbot UI on Amazon EKS using Terraform and Jenkins, ensuring secure, scalable, and efficient CI/CD workflows.
tone:
  - technical
  - automation-driven
  - secure
...
**GITHUB REPO**: [Chatbot-UI](https://github.com/Hemanshubt/ai-chatbot-eks-terraform-jenkins)

```
git clone https://github.com/Hemanshubt/ai-chatbot-eks-terraform-jenkins
...
pipeline{
    ...
    stages {
        stage('Checkout from Git'){
            steps{
                git branch: 'master', url: 'https://github.com/Hemanshubt/DevOps-Project-28/Chatbot-UI.git'
            }
        }
...
This project is crafted by **[Hemanshu](https://github.com/Hemanshubt)** 💡.  
