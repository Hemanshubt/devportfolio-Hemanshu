---
title: "DevOps Project-05: Deploy Your Code on a Docker Container using Jenkins on AWS"
summary: This project walks through building a CI/CD pipeline with Jenkins to deploy application code inside Docker containers on AWS infrastructure. It covers Jenkins setup, Docker image creation, and automated deployment workflows.
objective: Automate deployment of application code using Jenkins and Docker on AWS for streamlined CI/CD.
tone:
  - technical
  - hands-on
tags:
...
_After logging in to our EC2 machine we will install Jenkins following the instructions from the official Jenkins website: https://pkg.jenkins.io/redhat-stable/
...
- **GitHub**: [@NotHemanshu](https://github.com/NotHemanshu)  
- **Blog**: [ProDevOpsGuy](https://blog.prodevopsguy.xyz)  
- **Telegram Community**: [Join Here](https://t.me/prodevopsguy)  
- **LinkedIn**: [Hemanshu Vardhan Reddy](https://www.linkedin.com/in/Hemanshu-vardhan-reddy/)  
